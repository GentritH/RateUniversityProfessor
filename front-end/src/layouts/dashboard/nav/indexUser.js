...
//
import navConfigUser from './configNavUser';
...
NavUser.propTypes = {
  openNavUser: PropTypes.bool,
  onCloseNavUser: PropTypes.func,
};

export default function NavUser({ openNavUser, onCloseNavUser }) {

...
function CreateRateProfessor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://localhost:44364/api/RateProfessor/CreateRateProfessor', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        setSnackbarMessage('Failed to submit rating! The content of your feedback is toxic. ' + responseData.message);

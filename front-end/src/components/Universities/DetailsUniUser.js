...
import { ArrowBack as ArrowBackIcon, ExpandMore as ExpandMoreIcon, Close as CloseIcon, Edit as EditIcon, Visibility as VisibilityIcon } from '@mui/icons-material';
...
function DetailsUni() {
  ...
  return (
    ...
    onChange={(e) =>
      setUniversity({ ...university, establishedYear: parseInt(e.target.value) || 0 })
    }
  />
  <TextField
    label="Staff Number"
    ...
    onChange={(e) =>
      setUniversity({ ...university, staffNumber: parseInt(e.target.value) || 0 })
    }
  />
  <TextField
    ...
    onChange={(e) =>
      setUniversity({ ...university, studentsNumber: parseInt(e.target.value) || 0 })
    }
  />
  <TextField
    label="Course Number"
    ...
    onChange={(e) =>
      setUniversity({ ...university, coursesNumber: parseInt(e.target.value) || 0 })
    }
  />
        </DialogContent>
        <DialogActions>

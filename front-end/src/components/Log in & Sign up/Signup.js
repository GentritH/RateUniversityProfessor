...
import { Link, Container, Typography, Divider, Stack, Button, InputAdornment, TextField, IconButton, Checkbox,
          FormControl,
        InputLabel,
        Select, 
        MenuItem,
...
export default function Signup() {
  ...
  // const [password, setPassword] = useState("");
    ...
    const fetchUniversities = async () => {
      try {
        const universitiesResponse = await fetch('https://localhost:44364/api/University/GetAllUniversities');
    ...
    const handleSubmit = (e) => {
      ...
      axios
        .post("https://localhost:44364/api/Account/register", payload, {
          headers: {
